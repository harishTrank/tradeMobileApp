    ...
    <View style={styles.itemBox}>
      ...
      <View style={styles.mainRow}>
        <View style={[styles.rowChild, { alignItems: "flex-start" }]}>
          ...
          <Text style={[styles.defaultText, { color: "green" }]}>0</Text>
          <Text style={styles.defaultText}>Buy Avg Rate</Text>
          <Text style={[styles.defaultText, { color: "green" }]}>0.00</Text>
        </View>
...
const PercentOpenPositionScreen = ({ navigation }: any) => {
  ...
  return (
    <View style={styles.screen}>
      <BasicHeader navigation={navigation} title={"Percent Open Position"} />
